...
const TableCard: React.FC<TableCardProps> = ({ id, name, status, initials, seats }) => {
  ...
  return (
    <div onClick={handleClick} key={id} className="w-76 h-60  hover:bg-[#2c2c2c] bg-[#262626] p-4 rounded-lg cursor-pointer">
      ...
      <div className="flex items-center justify-center w-full p-4">
        <h1 className={`text-white rounded p-4 text-xl`} style={{ backgroundColor: initials ? getBgColor() : "#1f1f1f" }}>
